...
export default function TwitterPage() {
  ...
  return (
    <div className="flex flex-col gap-[14px]">
      <h2 className="text-[1.1rem] font-bold text-[#1f2937]">Twitter / X Analysis</h2>
      <p className="text-[0.74rem] text-[#6b7280] -mt-[10px]">
        Enter a public Twitter/X profile URL to scrape and analyse tweets. Uses a headless browser.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-[14px]">
        <div className="bg-white rounded-xl border border-[rgba(229,231,235,0.7)] p-[16px_18px]">
          ...
          >
            {loading ? 'Scraping...' : 'Scrape & Analyse Twitter'}
          </button>
          <p className="text-[0.62rem] text-[#9ca3af] mt-[6px]">Twitter/X may require login. Use File Upload with a Twitter archive instead.</p>
        </div>
          ...
          <div className="p-[14px_16px]">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center h-[200px] text-[#c4c9d0] gap-[5px]">
                <i className="ti ti-brand-x text-[22px]" />
