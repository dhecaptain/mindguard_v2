  ...
  return (
    <div className="flex flex-col gap-[14px]">
      ...
      <p className="text-[0.74rem] text-[#6b7280] -mt-[10px]">
        Enter a YouTube channel URL and API key to analyse video titles, descriptions, and comments.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-[14px]">
        <div className="bg-white rounded-xl border border-[rgba(229,231,235,0.7)] p-[16px_18px]">
          <div className="text-[0.62rem] font-bold text-[#374151] uppercase tracking-[0.06em] mb-[4px]">Channel URL</div>
          <input
            type="text"
            value={channelUrl}
          ...
          />
          <div className="text-[0.62rem] font-bold text-[#374151] uppercase tracking-[0.06em] mb-[4px]">YouTube API Key</div>
          <input
            type="password"
            value={apiKey}
          ...
          >
            {loading ? 'Analysing...' : 'Analyse YouTube Channel'}
          </button>
        </div>
        ...
        <div className="bg-white rounded-xl border border-[rgba(229,231,235,0.7)] overflow-hidden">
          ...
          <div className="p-[14px_16px]">
            {loading ? (
              <LoadingSpinner text="Fetching and analysing YouTube data..." />
            ) : !result ? (
              <div className="flex flex-col items-center justify-center h-[200px] text-[#c4c9d0] gap-[5px]">
                ...
                <span className="text-[0.65rem]">Enter a channel URL and click Analyse</span>
              </div>
            ) : (
              <>
                {activeTab === 'timeline' && (
