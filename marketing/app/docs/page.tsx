...
export default function DocsHomePage() {
  return (
    <div className="flex flex-col gap-6 text-sm leading-relaxed text-slate relative overflow-hidden">
      <FloatingOrb className="bg-teal-100/20 -top-10 -right-10" size={350} duration={18} />
      <Reveal>
